    ...
    return (
        <div>
            <div className="flex flex-col items-center bg-[#0F172A] pt-10">
                ...
                <div className="max-h-md flex max-w-md flex-row justify-center gap-10">
                    ...
                    <a href="#" target="_blank" className="block py-3">
                        <img
                            src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/Volkswagen_-_Logo.svg/2048px-Volkswagen_-_Logo.svg.png"
                            alt="gcp"
                            className="h-xs w-xs"
                        />
                    </a>
