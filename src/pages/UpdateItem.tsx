...
const UpdateItem: React.FC = () => {
    ...
    const [carBrand, setCarBrand] = useState<string>(car?.brand || "");
    ...
    const addNewItem = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch(`${CAR_SERVICE_API_URL}/update/${data.id}`, {
                method: "PUT",
                headers: {
                    ...
                    <div className="border-dark-6 flex min-h-[328px] items-center justify-center rounded-2xl border border-dashed bg-white/10 p-6 md:p-10">
                        <div className="w-full text-center">
                            <div className="mx-auto w-full max-w-[290px] text-center">
                                <h3 className="mb-10 text-4xl font-bold text-white">UPDATE ITEM</h3>
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <input
                                                        ...
                                                        name="carStatus"
                                                        value="Not Available"
                                                        checked={carStatus === "Not Available"}
                                                        onChange={(e) => setCarStatus(e.target.value)}
                                                        className="mr-2"
                                                    />
