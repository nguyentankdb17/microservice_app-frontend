...
const SuccessMessage: React.FC<Message> = ({ message, duration }) => {
    ...
    return (
        <div className="fixed top-4 left-1/2 z-[9999] inline-flex -translate-x-1/2 rounded-lg bg-green-200 px-[18px] py-4 shadow-lg">
            <p className="flex items-center text-sm font-medium text-[#004434]">
                <span className="mr-3 flex h-5 w-5 items-center justify-center rounded-full bg-green-600">
